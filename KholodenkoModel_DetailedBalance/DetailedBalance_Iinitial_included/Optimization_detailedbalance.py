...
petab_problem = petab.Problem.from_yaml(
   ...
   "/home/zah47/Initial_Conc_included/DB_Model/EGFR/EGFR.yaml"    #state the exact folder contains the yaml file
)
